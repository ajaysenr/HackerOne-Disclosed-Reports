...
|---|---|---|---|---|---|---|
| 1 | [617543](../reports/617543.md) | Arbitrary File Reading on Uber SSL VPN | [Uber](../by-program/uber.md) | High — CVSS 7.5 | $6,500 | 38 |
| 2 | [519367](../reports/519367.md) | Attacker can read password from log data | [Midpoint (European Commission - DIGIT)](../by-program/midpoint_h1c.md) | Low | $169 | 35 |
...
| 8 | [885041](../reports/885041.md) | The password of a mail share is not hashed if the password is giv | [Nextcloud](../by-program/nextcloud.md) | Low | — | 2 |
| 9 | [796139](../reports/796139.md) | Github test clientID and clientSecret leaked | [Kubernetes](../by-program/kubernetes.md) | Low | — | 2 |
