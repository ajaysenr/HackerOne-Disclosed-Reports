...
| | |
|---|---|
| **Report ID** | [5200](https://hackerone.com/reports/5200) |
...
| **Bounty** | — |
| **Votes** | 4 |
| **Reporter** | [zero](https://hackerone.com/zero) |
| **Asset** | — (—) |
| **CVE IDs** | — |
| **Reported** | 2014-03-30 |
