...
| | |
|---|---|
| **Report ID** | [1354255](https://hackerone.com/reports/1354255) |
| **Program** | [Fastify](../by-program/fastify.md) |
| **Severity** | Low — CVSS 3.7 |
| **Weakness** | [Open Redirect](../by-weakness/open-redirect.md) |
| **Bounty** | — |
| **Votes** | 3 |
| **Reporter** | [drstrnegth](https://hackerone.com/drstrnegth) |
| **Asset** | https://github.com/fastify (SOURCE_CODE) |
