...
| | |
|---|---|
| **Report ID** | [1064149](https://hackerone.com/reports/1064149) |
...
| **Bounty** | — |
| **Votes** | 8 |
| **Reporter** | [humayunalikhan](https://hackerone.com/humayunalikhan) |
...
> This refers to sanitization of an API that is already scheduled to be deleted. It doesn't appear to be exploitable.
