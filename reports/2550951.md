...
| | |
|---|---|
| **Report ID** | [2550951](https://hackerone.com/reports/2550951) |
| **Program** | [curl](../by-program/curl.md) |
| **Severity** | High — CVSS 8.2 |
| **Weakness** | [Encoding Error](../by-weakness/encoding-error.md) |
| **Bounty** | — |
| **Votes** | 12 |
| **Reporter** | [splitline](https://hackerone.com/splitline) |
