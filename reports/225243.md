...
| | |
|---|---|
| **Report ID** | [225243](https://hackerone.com/reports/225243) |
...
> Given a Rider or Driver's email address or UUID, an Attacker could find out their actual phone number.
