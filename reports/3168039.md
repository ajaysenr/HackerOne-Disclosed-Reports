...
| | |
|---|---|
| **Report ID** | [3168039](https://hackerone.com/reports/3168039) |
| **Program** | [curl](../by-program/curl.md) |
| **Severity** | Low |
| **Weakness** | [Loop with Unreachable Exit Condition ('Infinite Loop')](../by-weakness/loop-with-unreachable-exit-condition-'infinite-loop'.md) |
| **Bounty** | — |
| **Votes** | 57 |
