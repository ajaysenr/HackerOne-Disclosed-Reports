...
| | |
|---|---|
| **Report ID** | [2642615](https://hackerone.com/reports/2642615) |
| **Program** | [Sony](../by-program/sony.md) |
| **Severity** | High — CVSS 8.3 |
| **Weakness** | [Key Exchange without Entity Authentication](../by-weakness/key-exchange-without-entity-authentication.md) |
| **Bounty** | — |
| **Votes** | 71 |
| **Reporter** | [trapedev](https://hackerone.com/trapedev) |
