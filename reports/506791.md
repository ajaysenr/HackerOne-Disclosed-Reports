...
| | |
|---|---|
| **Report ID** | [506791](https://hackerone.com/reports/506791) |
| **Program** | [Central Security Project](../by-program/central-security-project.md) |
| **Severity** | High — CVSS 8.3 |
| **Weakness** | [XML Entity Expansion](../by-weakness/xml-entity-expansion.md) |
| **Bounty** | — |
| **Votes** | 1 |
| **Reporter** | [amassey](https://hackerone.com/amassey) |
| **Asset** | Java Component in search.maven.org (SOURCE_CODE) |
| **CVE IDs** | CVE-2019-5442 |
| **Reported** | 2019-03-08 |
