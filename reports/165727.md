...
| | |
|---|---|
| **Report ID** | [165727](https://hackerone.com/reports/165727) |
...
3) In attack windows you will see that all invalid code attempt came as same response code response message of "invalid_pin" but our valid code will came as different response length code response message like "{"ok":true,"token":"[SLACK_TOKEN_REDACTED]","user":"U1XBLN338","team":"T1UG4303E"}"
