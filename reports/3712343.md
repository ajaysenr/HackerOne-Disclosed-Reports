...
| | |
|---|---|
| **Report ID** | [3712343](https://hackerone.com/reports/3712343) |
| **Program** | [curl](../by-program/curl.md) |
| **Severity** | Critical |
| **Weakness** | [ASI05: Unexpected Code Execution (RCE)](../by-weakness/asi05:-unexpected-code-execution-rce.md) |
| **Bounty** | — |
| **Votes** | 4 |
| **Reporter** | [orelbn7](https://hackerone.com/orelbn7) |
