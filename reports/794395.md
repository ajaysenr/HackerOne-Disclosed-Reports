...
| | |
|---|---|
| **Report ID** | [794395](https://hackerone.com/reports/794395) |
| **Program** | [CompanyHub](../by-program/companyhub.md) |
| **Severity** | Medium |
| **Weakness** | — |
| **Bounty** | — |
| **Votes** | 19 |
| **Reporter** | [el_chapo](https://hackerone.com/el_chapo) |
| **Asset** | *.companyhub.com (WILDCARD) |
| **CVE IDs** | — |
| **Reported** | 2020-02-12 |
