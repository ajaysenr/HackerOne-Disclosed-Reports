...
| | |
|---|---|
| **Report ID** | [774896](https://hackerone.com/reports/774896) |
...
| **Bounty** | — |
| **Votes** | 9 |
| **Reporter** | [mr_incompetent](https://hackerone.com/mr_incompetent) |
| **Asset** | https://github.com/kubernetes/kubernetes (SOURCE_CODE) |
| **CVE IDs** | CVE-2020-8551 |
| **Reported** | 2020-01-14 |
| **Disclosed** | 2020-10-31 |
| **Resolution** | Resolved |
