...
| | |
|---|---|
| **Report ID** | [1132803](https://hackerone.com/reports/1132803) |
| **Program** | [On ](../by-program/on.md) |
| **Severity** | Low |
| **Weakness** | [Misconfiguration](../by-weakness/misconfiguration.md) |
| **Bounty** | — |
| **Votes** | 55 |
| **Reporter** | [sahil__soni](https://hackerone.com/sahil__soni) |
| **Asset** | *.on-running.com (WILDCARD) |
| **CVE IDs** | — |
| **Reported** | 2021-03-23 |
