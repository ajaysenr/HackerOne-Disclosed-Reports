...
| | |
|---|---|
| **Report ID** | [776017](https://hackerone.com/reports/776017) |
...
| **Bounty** | $5,000 |
| **Votes** | 21 |
| **Reporter** | [reeverzax](https://hackerone.com/reeverzax) |
| **Asset** | https://github.com/kubernetes/kube-controller-manager (SOURCE_CODE) |
| **CVE IDs** | CVE-2020-8555 |
| **Reported** | 2020-01-15 |
