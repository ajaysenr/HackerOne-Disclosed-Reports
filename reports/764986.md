...
| | |
|---|---|
| **Report ID** | [764986](https://hackerone.com/reports/764986) |
...
| **Bounty** | — |
| **Votes** | 2 |
| **Reporter** | [champtar](https://hackerone.com/champtar) |
| **Asset** | https://github.com/kubernetes/kube-proxy (SOURCE_CODE) |
| **CVE IDs** | CVE-2020-8554 |
| **Reported** | 2019-12-27 |
