...
| | |
|---|---|
| **Report ID** | [576288](https://hackerone.com/reports/576288) |
| **Program** | [Chainlink](../by-program/chainlink.md) |
| **Severity** | Low |
| **Weakness** | [Cleartext Transmission of Sensitive Information](../by-weakness/cleartext-transmission-of-sensitive-information.md) |
| **Bounty** | — |
| **Votes** | 19 |
| **Reporter** | [jaisharma](https://hackerone.com/jaisharma) |
| **Asset** | rinkeby.chain.link (URL) |
| **CVE IDs** | — |
| **Reported** | 2019-05-10 |
