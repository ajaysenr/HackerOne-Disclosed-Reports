...
| | |
|---|---|
| **Report ID** | [1624670](https://hackerone.com/reports/1624670) |
| **Program** | [U.S. Dept Of Defense](../by-program/deptofdefense.md) |
| **Severity** | High — CVSS 7.5 |
| **Weakness** | [PHP Local File Inclusion](../by-weakness/php-local-file-inclusion.md) |
| **Bounty** | $500 |
| **Votes** | 11 |
| **Reporter** | [demon1c](https://hackerone.com/demon1c) |
| **Asset** | — (—) |
| **CVE IDs** | — |
| **Reported** | 2022-07-04 |
