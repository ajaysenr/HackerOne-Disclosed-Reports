...
| | |
|---|---|
| **Report ID** | [1429694](https://hackerone.com/reports/1429694) |
| **Program** | [Node.js](../by-program/nodejs.md) |
| **Severity** | Medium — CVSS 6.8 |
| **Weakness** | [Improper Following of a Certificate's Chain of Trust](../by-weakness/improper-following-of-a-certificate's-chain-of-trust.md) |
| **Bounty** | — |
| **Votes** | 2 |
| **Reporter** | [bengl](https://hackerone.com/bengl) |
| **Asset** | https://github.com/nodejs/node (SOURCE_CODE) |
| **CVE IDs** | CVE-2021-44531, CVE-2021-44532, CVE-2021-44533 |
| **Reported** | 2021-12-17 |
