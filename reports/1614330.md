...
| | |
|---|---|
| **Report ID** | [1614330](https://hackerone.com/reports/1614330) |
...
This flaw exists with just one of the compression algorithms built-in (gzip, brotli or zstd), but the individual algorithms has different "exploding" powers.
...
Security Advisory: https://curl.se/docs/CVE-2022-32206.html
