...
| | |
|---|---|
| **Report ID** | [1820953](https://hackerone.com/reports/1820953) |
...
> Shopify merchants can purchase and manage domains through Shopify. As part of this service, shop owners can delegate the `Transfer domain to another Shopify store` permission to shop staff, which allows staff to transfer domains from one shop to another. 

Staff members without the `Transfer domain to another Shopify store` permission were able to transfer the shops domain to another provider.  
