...
| | |
|---|---|
| **Report ID** | [2800511](https://hackerone.com/reports/2800511) |
| **Program** | [AWS VDP](../by-program/aws_vdp.md) |
| **Severity** | Medium — CVSS 6.5 |
| **Weakness** | [Reusing Session IDs (aka Session Replay)](../by-weakness/reusing-session-ids-aka-session-replay.md) |
| **Bounty** | — |
| **Votes** | 36 |
| **Reporter** | [xendaviour](https://hackerone.com/xendaviour) |
| **Asset** | AWS IAM Identity Center (OTHER) |
| **CVE IDs** | — |
| **Reported** | 2024-10-24 |
