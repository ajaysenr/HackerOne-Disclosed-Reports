...
| | |
|---|---|
| **Report ID** | [966949](https://hackerone.com/reports/966949) |
| **Program** | [Yelp](../by-program/yelp.md) |
| **Severity** | Low |
| **Weakness** | [Business Logic Errors](../by-weakness/business-logic-errors.md) |
| **Bounty** | — |
| **Votes** | 4 |
| **Reporter** | [cocoh__23](https://hackerone.com/cocoh__23) |
...
> @cocoh__23 reported that they could modify the `locid` parameter in https://yelp.com/profile_location/add_or_edit endpoint to disclose an arbitrary location stored in the database. 
