...
| | |
|---|---|
| **Report ID** | [2534300](https://hackerone.com/reports/2534300) |
| **Program** | [Ionity GmbH](../by-program/ionity_gmbh.md) |
| **Severity** | Low |
| **Weakness** | [Cross-site Scripting (XSS) - Generic](../by-weakness/cross-site-scripting-xss---generic.md) |
| **Bounty** | — |
| **Votes** | 31 |
| **Reporter** | [ehaftab](https://hackerone.com/ehaftab) |
| **Asset** | *.ionity.eu (WILDCARD) |
| **CVE IDs** | — |
| **Reported** | 2024-06-03 |
