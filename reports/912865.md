...
| | |
|---|---|
| **Report ID** | [912865](https://hackerone.com/reports/912865) |
| **Program** | [SMTP2GO](../by-program/smtp2go-vdp.md) |
| **Severity** | Medium |
| **Weakness** | [Cross-site Scripting (XSS) - Stored](../by-weakness/cross-site-scripting-xss---stored.md) |
| **Bounty** | — |
| **Votes** | 29 |
| **Reporter** | [testerpro](https://hackerone.com/testerpro) |
| **Asset** | app.smtp2go.com (URL) |
| **CVE IDs** | — |
| **Reported** | 2020-07-01 |
