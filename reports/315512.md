...
| | |
|---|---|
| **Report ID** | [315512](https://hackerone.com/reports/315512) |
| **Program** | [Coalition, Inc.](../by-program/coalition.md) |
| **Severity** | Medium |
| **Weakness** | [Improper Authentication - Generic](../by-weakness/improper-authentication---generic.md) |
| **Bounty** | — |
| **Votes** | 6 |
| **Reporter** | [startedfromthebottom](https://hackerone.com/startedfromthebottom) |
| **Asset** | platform.thecoalition.com (URL) |
| **CVE IDs** | — |
| **Reported** | 2018-02-13 |
