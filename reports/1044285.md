...
| | |
|---|---|
| **Report ID** | [1044285](https://hackerone.com/reports/1044285) |
| **Program** | [Shopify](../by-program/shopify.md) |
| **Severity** | Medium — CVSS 4.6 |
| **Weakness** | — |
| **Bounty** | $2,900 |
| **Votes** | 58 |
| **Reporter** | [adarshxs](https://hackerone.com/adarshxs) |
