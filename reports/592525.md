...
| | |
|---|---|
| **Report ID** | [592525](https://hackerone.com/reports/592525) |
...
| **Bounty** | — |
| **Votes** | 5 |
| **Reporter** | [rugged_info](https://hackerone.com/rugged_info) |
| **Asset** | react-autolinker-wrapper (SOURCE_CODE) |
| **CVE IDs** | — |
| **Reported** | 2019-05-30 |
| **Disclosed** | 2019-12-15 |
| **Resolution** | Resolved |
