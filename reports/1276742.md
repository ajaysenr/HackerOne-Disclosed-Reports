...
| | |
|---|---|
| **Report ID** | [1276742](https://hackerone.com/reports/1276742) |
...
Our engineers deployed a fix that avoid converting the `data:` URL into a `blob:` URL, which impedes the exploitation of this vulnerability.
