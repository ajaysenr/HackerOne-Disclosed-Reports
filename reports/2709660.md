...
| | |
|---|---|
| **Report ID** | [2709660](https://hackerone.com/reports/2709660) |
| **Program** | [HackerOne](../by-program/security.md) |
| **Severity** | Low — CVSS 3.7 |
| **Weakness** | [Reliance on Reverse DNS Resolution for a Security-Critical Action](../by-weakness/reliance-on-reverse-dns-resolution-for-a-security-critical-action.md) |
| **Bounty** | — |
| **Votes** | 60 |
| **Reporter** | [raditz](https://hackerone.com/raditz) |
| **Asset** | hackerone.com (URL) |
| **CVE IDs** | — |
| **Reported** | 2024-09-10 |
| **Disclosed** | 2024-11-14 |
| **Resolution** | Resolved |
