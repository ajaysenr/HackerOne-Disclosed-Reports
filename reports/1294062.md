...
| | |
|---|---|
| **Report ID** | [1294062](https://hackerone.com/reports/1294062) |
| **Program** | [Twitter Algorithmic Bias](../by-program/twitter-algorithmic-bias.md) |
| **Severity** | Critical |
| **Weakness** | [Improper Input Validation](../by-weakness/improper-input-validation.md) |
| **Bounty** | — |
| **Votes** | 10 |
| **Reporter** | [cyberqueenmeg](https://hackerone.com/cyberqueenmeg) |
| **Asset** | — (—) |
| **CVE IDs** | — |
| **Reported** | 2021-08-06 |
