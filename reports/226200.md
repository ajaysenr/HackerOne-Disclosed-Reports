...
| | |
|---|---|
| **Report ID** | [226200](https://hackerone.com/reports/226200) |
| **Program** | [shopify-scripts](../by-program/shopify-scripts.md) |
| **Severity** | Critical |
| **Weakness** | [Write-what-where Condition](../by-weakness/write-what-where-condition.md) |
| **Bounty** | — |
| **Votes** | 3 |
| **Reporter** | [avisaven](https://hackerone.com/avisaven) |
| **Asset** | — (—) |
| **CVE IDs** | — |
| **Reported** | 2017-05-04 |
