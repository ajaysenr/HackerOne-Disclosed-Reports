...
| | |
|---|---|
| **Report ID** | [3515557](https://hackerone.com/reports/3515557) |
| **Program** | [Monero](../by-program/monero.md) |
| **Severity** | Medium |
| **Weakness** | [Business Logic Errors](../by-weakness/business-logic-errors.md) |
| **Bounty** | — |
| **Votes** | 1 |
| **Reporter** | [k-privacy-enjoyer](https://hackerone.com/k-privacy-enjoyer) |
| **Asset** | — (—) |
| **CVE IDs** | — |
| **Reported** | 2026-01-18 |
...
I read https://github.com/monero-project/meta/blob/master/VULNERABILITY_RESPONSE_PROCESS.md

The link to available xmr for bounties does not work.

My address

`88AHxEzRjyq1Jd4BMah9jVGi8jUdtd9DRK5KtFFYQjA5HSCg9T8zJG1CJZLKrN1xytYSPy5jq7XtXRnVrxTdHHUS5hJpK2D`

## Impact

Loss of funds from the multisig due to multiple sends induced by the malicious participant when only one was intended.
