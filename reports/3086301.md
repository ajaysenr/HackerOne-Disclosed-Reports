...
| | |
|---|---|
| **Report ID** | [3086301](https://hackerone.com/reports/3086301) |
| **Program** | [Brave Software](../by-program/brave.md) |
| **Severity** | High — CVSS 8.8 |
| **Weakness** | [LLM01: Prompt Injection](../by-weakness/llm01:-prompt-injection.md) |
| **Bounty** | — |
| **Votes** | 77 |
| **Reporter** | [stellersjay](https://hackerone.com/stellersjay) |
